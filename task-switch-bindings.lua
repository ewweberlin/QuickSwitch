-- ewwe.task-switch — bindings to inject into the Hyprland Lua config
...
hl.unbind("SUPER + TAB")
o.bind("SUPER + TAB", "Task switch", hl.dsp.global("ewwe.task-switch:next"), { repeating = true })
...
hl.layer_rule({ match = { namespace = "ewwe.task-switch" }, no_anim = true })
